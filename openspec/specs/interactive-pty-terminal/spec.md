# interactive-pty-terminal Specification

## Purpose

TBD - created by archiving change 'interactive-pty-terminal'. Update Purpose after archive.
...
<!-- @trace
source: interactive-pty-terminal
updated: 2026-06-29
code:
  - docs/env.md
  - crates/fleety-tools/src/terminal.rs
