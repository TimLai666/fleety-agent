...
- Affected specs: `cli-command-surface`, `terminal-workspace`, `cli-workflow-integrity`, `interactive-config-panel`, `interactive-chat-tui`, `owner-routed-configuration`, `connection-profiles`, `provider-config-surface`
- Affected code:
  - Modified: `crates/fleety-cli/src/main.rs`, `crates/fleety-cli/src/config.rs`, `crates/fleety-cli/src/config_panel.rs`, `crates/fleety-cli/src/provider_tui.rs`, `crates/fleety-cli/src/tui.rs`, `crates/fleety-cli/src/server.rs`, `crates/fleety-cli/src/auth.rs`, `crates/fleety-cli/tests/cli_smoke.rs`, `crates/fleety-daemon/src/main.rs`, `crates/fleety-daemon/tests/fleetyd_smoke.rs`, `crates/fleety-server/src/main.rs`, `crates/fleety-server/tests/server_smoke.rs`, `crates/fleety-tools/src/config.rs`, `crates/fleety-tools/src/connection.rs`, `README.md`, `docs/design-cli-config.md`, `docs/env.md`, `docs/STATUS.md`
