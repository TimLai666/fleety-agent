...
The baseline is grounded in the four embedded behavioural docs under the prompts directory and the prompt-assembly code in the fleety-server storage module (its system_prompt and core_memory functions).
